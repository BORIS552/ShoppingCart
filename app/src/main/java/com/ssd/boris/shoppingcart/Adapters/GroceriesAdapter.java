...
public class GroceriesAdapter extends RecyclerView.Adapter<GroceriesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position){
        final Groceries groceries = groceriesList.get(position);
        holder.name.setText(groceries.getProd_name());
        holder.price.setText(String.format("%.2f",groceries.getProd_price()));
        Glide.with(context)
                .load(groceries.getProd_image())
        ...
        holder.buynow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(context, "Buy Now: "+groceries.getProd_category() +" : "+ groceries.getProd_id(), Toast.LENGTH_LONG).show();
            }
        });
        ...
        holder.wishlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog.show();
                Toast.makeText(context, "Wishlist: "+groceries.getProd_category() +" : "+ groceries.getProd_id(), Toast.LENGTH_LONG).show();
                String url = IConstants.wishlist_post_url;
                //creating json data for wishlist...
                try {
                    JSONObject jsonObject = new JSONObject();
                    jsonObject.put("prod_id", groceries.getProd_id());
