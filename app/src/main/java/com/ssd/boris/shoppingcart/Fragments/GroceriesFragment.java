...
import com.ssd.boris.shoppingcart.Adapters.GroceriesAdapter;
...
public class GroceriesFragment extends Fragment {
    ...
    private static final String URL = IConstants.url+"groceries";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        groceriesAdapter = new GroceriesAdapter(getActivity(), groceriesList);
        ...
        JsonArrayRequest request = new JsonArrayRequest(URL,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        List<Groceries> items = new Gson().fromJson(response.toString(), new TypeToken<List<Groceries>>(){}.getType());
                        groceriesList.clear();
                        groceriesList.addAll(items);
