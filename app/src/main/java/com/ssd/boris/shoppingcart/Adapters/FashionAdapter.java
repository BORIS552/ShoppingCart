...
import com.ssd.boris.shoppingcart.productmodel.Fashion;
...
public class FashionAdapter extends RecyclerView.Adapter<FashionAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position){
        final Fashion fashion = fashionList.get(position);
        holder.name.setText(fashion.getProd_name());
        holder.price.setText(String.format("%.2f",fashion.getProd_price()));
        Glide.with(context)
                .load(fashion.getProd_image())
        ...
        holder.buynow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(context, "Buy Now: "+fashion.getProd_category() +" : "+ fashion.getProd_id(), Toast.LENGTH_LONG).show();
            }
        });
        ...
        holder.wishlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog.show();
                Toast.makeText(context, "Wishlist: "+fashion.getProd_category() +" : "+ fashion.getProd_id(), Toast.LENGTH_LONG).show();
                String url = IConstants.wishlist_post_url;
                //creating json data for wishlist...
                try {
                    JSONObject jsonObject = new JSONObject();
                    jsonObject.put("prod_id", fashion.getProd_id());
