...
import com.ssd.boris.shoppingcart.Adapters.WishListAdapter;
...
public class WishListFragment extends Fragment {
    ...
    private ElectronicsFragment.OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        wishListAdapter = new WishListAdapter(getActivity(), wishListList);
    ...
    private void fetchElectronicStoreItem(){
        ...
        String URL = IConstants.wishlist_url+sharedPreferences.getString(Email,"");
        JsonArrayRequest request = new JsonArrayRequest(URL,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        List<WishList> items = new Gson().fromJson(response.toString(), new TypeToken<List<WishList>>(){}.getType());
                        wishListList.clear();
                        wishListList.addAll(items);
