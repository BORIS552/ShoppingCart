...
import com.ssd.boris.shoppingcart.Adapters.FashionAdapter;
...
public class FashionFragment extends Fragment {
    ...
    private static final String URL = IConstants.url+"fashion";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fashionAdapter = new FashionAdapter(getActivity(), fashionList);
        ...
        JsonArrayRequest request = new JsonArrayRequest(URL,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        List<Fashion> items = new Gson().fromJson(response.toString(), new TypeToken<List<Fashion>>(){}.getType());
                        fashionList.clear();
                        fashionList.addAll(items);
