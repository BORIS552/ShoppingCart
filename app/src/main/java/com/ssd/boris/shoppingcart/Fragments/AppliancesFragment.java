...
import com.ssd.boris.shoppingcart.Adapters.AppliancesAdapter;
...
public class AppliancesFragment extends Fragment {
    ...
    private static final String URL = IConstants.url+"appliances";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        appliancesAdapter = new AppliancesAdapter(getActivity(), appliancesList);
        ...
        JsonArrayRequest request = new JsonArrayRequest(URL,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        List<Appliances> items = new Gson().fromJson(response.toString(), new TypeToken<List<Appliances>>(){}.getType());
                        appliancesList.clear();
                        appliancesList.addAll(items);
