...
import com.ssd.boris.shoppingcart.productmodel.Appliances;
...
public class AppliancesAdapter extends RecyclerView.Adapter<AppliancesAdapter.MyViewHolder> {
    ...
    public AppliancesAdapter(Context context, List<Appliances> appliancesList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position){
        final Appliances appliances = appliancesList.get(position);
        holder.name.setText(appliances.getProd_name());
        holder.price.setText(String.format("%.2f",appliances.getProd_price()));
        Glide.with(context)
                .load(appliances.getProd_image())
        ...
        holder.buynow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(context, "Buy Now: "+appliances.getProd_category() +" : "+ appliances.getProd_id(), Toast.LENGTH_LONG).show();
            }
        });
        ...
        holder.wishlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog.show();
                Toast.makeText(context, "Wishlist: "+appliances.getProd_category() +" : "+ appliances.getProd_id(), Toast.LENGTH_LONG).show();
                String url = IConstants.wishlist_post_url;
                //creating json data for wishlist...
                try {
                    JSONObject jsonObject = new JSONObject();
                    jsonObject.put("prod_id", appliances.getProd_id());
